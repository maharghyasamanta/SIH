  ...
  return (
    <div className={cn("min-h-screen", dark ? "bg-[#0b1117] text-white" : "bg-[#f7f9fb] text-slate-950")}>
      <aside className={cn("fixed inset-y-0 left-0 z-50 flex w-[248px] -translate-x-full flex-col border-r transition-transform lg:translate-x-0", open && "translate-x-0", dark ? "border-white/8 bg-[#101820]" : "border-slate-200 bg-white")}>
        ...
        <div className={cn("m-4 rounded-xl p-4", dark ? "bg-[#18242d]" : "bg-[#f5f7f8]")}><div className="mb-3 flex items-center gap-2"><Users size={15} className={dark ? "text-[#73c6a6]" : "text-[#337e69"} /><span className="text-[11px] font-bold uppercase tracking-[.12em] text-slate-400">Response network</span></div><p className={cn("text-[12px] leading-5", dark ? "text-slate-300" : "text-slate-600")}>Connected to 48 field teams across the demo region.</p><div className="mt-3 flex -space-x-2"><span className="avatar bg-[#d8a57c]">AR</span><span className="avatar bg-[#719e96]">VS</span><span className="avatar bg-[#8f7cae]">NK</span><span className="flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-slate-200 text-[9px] font-bold text-slate-600">+45</span></div></div>
      </aside>
