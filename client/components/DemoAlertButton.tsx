...
export function DemoAlertButton() {
  ...
  const [message, setMessage] = useState("Cloud burst alert: Elevated disaster risk detected in Zone 4. Follow official instructions and move toward designated shelters. Weather: Heavy rain and thunderstorms. Temperature: 11°C.");
